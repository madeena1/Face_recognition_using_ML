% %This is script for face recognition using KNN classifier and 10 fold
% cross validation
% 
...
% Perform KNN classification and report the correct and error rates
for i = 1:nFold
    ...
    % fit KNN classifier
    modl = fitcknn(dbset.trn,dbset.trngnd,'NumNeighbors',3,'Standardize',1);
    
    %Predict classes of test set using trained model
    class = predict(modl,dbset.tst);
...
%Display results
disp('Face Recognition using KNN')
disp('=========================================================')
